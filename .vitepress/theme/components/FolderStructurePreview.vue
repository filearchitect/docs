      ...
      <div class="folder-item">
        ...
        <div v-if="item.children?.length" class="folder-children">
          ...
          >
            ...
            <div v-if="child.children?.length" class="folder-children">
              <div
              ...
              >
                <div class="folder-content">
                  <Icon
                    ...
                    height="20"
                  />
                  <span class="folder-text">{{ subChild.name }}</span>
                </div>
                <div v-if="subChild.children?.length" class="folder-children">
                  <div
                    v-for="(grandChild, grandChildIndex) in subChild.children"
                    :key="grandChildIndex"
                    class="folder-item"
                  >
                    <div class="folder-content">
                      <Icon
                        ...
                        height="20"
                      />
                      <span class="folder-text">{{ grandChild.name }}</span>
                    </div>
                    <div
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          v-if="greatGrandChild.children?.length"
                          class="folder-children"
                        >
                          <div
                            v-for="(
                              superChild, superChildIndex
